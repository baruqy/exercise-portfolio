...
export default function Profile() {
    return (
        <div id="profile" className="section">
            <div className="container mx-auto mx-w-[1200px] p-3 overflow-hidden">
                <div className="font-secondary text-center font-bold mb-12" 
                data-aos="zoom-in-down"
                data-aos-easing="linear"
                data-aos-diration="1000"
                >
                    <h4 className="text-secondary mb-3">Newbie Skill</h4>
                    <h2 className="text-gradient font-primary max-w-[700px] mx-auto text-[24px]">
                        Great consectetur adipisicing elit. Dolorum error dolores perferendis itaque quae quasi placeat cupiditate odio provident rerum.
                    </h2>
                </div>
                <div className="flex flex-col lg:flex-row items-start justify-between">
                    ...
                    data-aos-diration="1000"
                    >
                        <div className="min-w-[300px] bg-gradient pt-[50px] rounded-full overflow-hidden">
